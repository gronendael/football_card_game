...
- A Change of Possession may occur due to a Turnover, Running out of Drive Points (Turnover on Downs), 1st Half ends, Punt play, Kickoff Play
...
KICKOFF PLAYS
- Kicking Team kicks off ball to Receiving Team
- Kicking zone distance is based on the Kickers's stats for the Kicking team
- Receiving Team returns the kickoff
- Kicking team must run and tackle the Returner
- Returner may be tackled in Zone they caught the ball, Advance any number of Zones, or may run it all the way back for a TD

PUNTING PLAYS
- Punting team punts the ball to Receiving Team
- Punting zone distance is based on the Punter's stats for the Punting team
- Punts may be blocked be the Defense
- Receiving Team returns the punt with their Returner
- Punting team must run and tackle the Returner
- Returner may be tackled in Zone they caught the ball, Advance any number of Zones, or may run it all the way back for a TD
...
- Turnover on Downs (OFF Drive Points are 0)
- Turnovers
